...
def main():
    ticker_list = world_1000_tickers
    ...
    # Calculate the sum of frequencies for each percentage across all companies
    total_frequencies = result_df.sum(axis=1)
    result_df['Total_Frequency'] = total_frequencies

...
# Fetch historical data for the past 40 days
...
# Main live trading function with continuous monitoring
def live_trading(ticker, interval=60):
    """Continuously monitor stock prices and execute trades."""
    while True:
        try:
...
live_trading(ticker, interval=60)  # Check every 60 seconds

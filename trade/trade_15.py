...
world_500_tickers = ['CVCO', 'NVCR', 'FNLC', 'NVEC', 'UONEK', 'STRT', 'CEAD', 'SLAB', 'AXON', 'AGNC', 'SCOR', 'STRR', 'STRS', 'SCNX', 'SCNI', 'CMRX']
...
def get_historical_data(ticker):
    ...
    stock_data['1322_MA'] = stock_data['Close'].rolling(window=1322).mean()  # 计算1322日均线
    return stock_data
...
def backtest_strategy():
    ...
    for ticker in world_500_tickers:
        ...
        for index, row in stock_data.iterrows():
            ...
            moving_avg_1322 = row['1322_MA']

            # 条件1: 如果价格低于1322日均线的92%，买入
            if current_price <= moving_avg_1322 * 0.76 and portfolio[ticker] == 0:  # 没有持仓时买入
            ...
            # 条件2: 如果价格涨回到1322日均线的95%，卖出
            elif current_price > moving_avg_1322 * 0.95 and portfolio[ticker] > 0:  # 持仓时卖出
